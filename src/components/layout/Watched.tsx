...
export default function Watched() {
  ...
  const navigateToContent = (mediaType: string, id: string, name: string) => {
    const slug = createContentSlug(name, id);
              ...
              >
                ...
                <div className="flex flex-col gap-5">
                  <div className=" flex flex-col gap-1">
                    ...
                    <h2 className="text-white/50 text-[13px]">{movie.mediaType}</h2>
                  </div>
                  <div className="flex gap-2 justify-start items-center">
                    <button
                      ...
                      onClick={() =>
                        navigateToContent(movie.mediaType, movie.id, movie.name)
                      }
                    >
                      Info
                    </button>
